...
public class client_frame extends javax.swing.JFrame 
{
    ...
    //display that client is diaconnected in client window.
    ...
    //When client run code to show Client Window 
    public client_frame() 
    {
        initComponents();
    }
    
    //To display different messages like new client connect,client disconnect or chat
    ...
    private void initComponents() {
      ...
      //Click listener for disconnect button
        ...
        //set different views in client window
    ...
    //When client try to connect with server
  ...
  //When client try to disconnect with server
  ...
  //When client try to login with server
  ...
  //When client try to send message
