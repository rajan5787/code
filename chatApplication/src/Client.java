...
public class Client extends javax.swing.JFrame {
    ...
    //Notify users that someone disconnect from server
    ...
    //When user press disconnect button ,this method try to disconnect user with server
    ...
    //Constructor for Initialite UI of Client
    public Client() {
        initComponents();
    ...
    //initiation different view of UI
    ...
    //When user press connect button,this method try to connect user with server
    private void connect_serverActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    //When user send messege into group
    ...
    private void disconnect_serverActionPerformed(java.awt.event.ActionEvent evt) {
